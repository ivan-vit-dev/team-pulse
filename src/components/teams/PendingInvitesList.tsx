...
import { revokeInviteAction } from "@/app/[locale]/(app)/teams/[teamId]/admin/actions";
...
type ClientSafeInvite = Omit<AdminInvite, "createdAt" | "updatedAt">;
...
export function PendingInvitesList({
  ...
  async function handleRevoke(inviteId: string) {
    ...
    try {
      await revokeInviteAction(teamId, inviteId);
      router.refresh();
    } finally {
      setRevokingId(null);
    }
